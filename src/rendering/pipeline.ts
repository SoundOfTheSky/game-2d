import { WebGPUIndexBuffer } from './index-buffer'
import { WebGPUVertex } from './vertex'
import { device, presentationFormat } from './webgpu'

export class WebGPUPipeline<V extends WebGPUVertex<any>[] | undefined> {
  ...
  public vertex?: V
  public index?: WebGPUIndexBuffer
  ...
  public render(pass: GPURenderPassEncoder) {
    ...
    if (this.index) {
      ...
      pass.drawIndexed(this.index.indexCount, instanceCount)
    } else pass.draw(vertexCount, instanceCount)
  }
}
